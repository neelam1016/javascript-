...
app.post("/postlogindata",(req,res)=>{
     ...
     //let udata={uname:'galineelam73@gmail.com',password:"Neelam@2001"};
    ...
    //  if(email===udata.uname && password===udata.password){
    //     session=req.session;
...
app.post("/postdata",(req,res)=>{
    ...
    // userModel.create({ username: uname, password: hash })
    //     .then(data => {
    //         res.redirect("/login")
    //     })
    //     .catch(err => {
    //         res.render("registration", { errMsg: "User Already Registered" })
    //     })
    ins.save((err,data)=>{
...
const uploadsingle=imageUpload.single("att")
